...
public class Account {
	...
	private static double annualInterestRate = 0.045; // The annual interest rate - applies to all accounts
	
	// Construct an account and set the id, balance and date of creation
